...
<div class="container mx-auto max-w-6xl p-4">
    ...
    <footer class="mt-6 text-center text-sm text-gray-500">
        <p>SEA-LION Chatbot © 2023 | Powered by Gemma AI | <a href="#" class="text-yellow-600 hover:underline">Privacy Policy</a> | <a href="#" class="text-yellow-600 hover:underline">Terms of Service</a></p>
    </footer>
</div>
...
""",height=800, width=10000, scrolling=1)
